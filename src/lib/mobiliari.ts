...
export type TipusMoble =
  ...
  | "consola" | "prestatgeria" | "sofa" | "llit" | "moble";
export type Moble = {
...
const SEED: Omit<Moble,"marca">[] = [
  ...
  { slug: "arles", nom: "Arles", tipus: "butaca", pvpDesde: 611.95, colors: [{ slug: "principal", nom: "" }] },
  ...
  { slug: "orion", nom: "Orion", tipus: "aparador", pvpDesde: 1954.95, colors: [{ slug: "principal", nom: "" }] },
  { slug: "lyra", nom: "Lyra", tipus: "taula-menjador", pvpDesde: 1853.95, colors: [{ slug: "principal", nom: "" }] },
  ...
  { slug: "volans", nom: "Volans", tipus: "moble", pvpDesde: 555.95, colors: [{ slug: "principal", nom: "" }] },
  { slug: "virgo", nom: "Virgo", tipus: "tauleta-nit", pvpDesde: 267.95, colors: [{ slug: "preto", nom: "Negre" }, { slug: "branco", nom: "Blanc" }] },
  { slug: "pegasus", nom: "Pegasus", tipus: "taula-menjador", pvpDesde: 680.95, colors: [{ slug: "principal", nom: "" }] },
  ...
  { slug: "dorado", nom: "Dorado", tipus: "taula-auxiliar", pvpDesde: 538.95, colors: [{ slug: "principal", nom: "" }] },
]
